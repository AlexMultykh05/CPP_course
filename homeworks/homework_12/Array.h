...
namespace lib {
    ...
    private:
        ...
        void remove_block_if_needed();

        void add_block_if_needed();

        void swap_all(Array<element> &other) noexcept;
    ...
    template<typename element>
    void Array<element>::swap_all(Array<element> &other) noexcept {
    ...
    template<typename element>
    void Array<element>::remove_block_if_needed() {
    ...
    template<typename element>
    void Array<element>::add_block_if_needed() {
    ...
    template<typename element>
    template<bool constant>
    Array<element>::iterator_base<constant>::iterator_base(std::conditional_t<constant, const Array<element> *, Array<element> *> array, size_t pos): array_(array),
                                                                                               pos_(pos) {}
